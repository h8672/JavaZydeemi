...
package game2d.state.object.actor.actors;
...
import game2d.state.item.equipment.AssaultRifle;
import game2d.state.item.equipment.Clothes;
import game2d.state.item.equipment.Flamethrower;
import game2d.state.item.equipment.Pistol;
import game2d.state.item.equipment.RocketLauncher;
import game2d.state.object.actor.Actors;
...
public class Player extends Actors {
    ...
    public void update() {
        ...
        if (Keyboard.isKeyDown(Keyboard.KEY_O) && Keyboard.isKeyDown(Keyboard.KEY_RSHIFT)){
            this.setWeapon(new RocketLauncher());
            this.getWeapon().setAmmunation(999);
